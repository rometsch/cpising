...
set key bottom left
unset yrange
plot  file1 u 1:2 ls 1 title label1, \
      file2 u 1:2 ls 2 title label2, \
      file3 u 1:2 ls 3 title label3, \
      file4 u 1:2 ls 4 title label4, \
      file5 u 1:2 ls 5 title label5, \
      file6 u 1:2 ls 6 title label6, \
      file7 u 1:2 ls 7 title label7, \
      file8 u 1:2 ls 8 title label8, \
      e(x) title "e"
...
set key top left
unset yrange
plot  file1 u 1:4 ls 1 title label1, \
      file2 u 1:4 ls 2 title label2, \
      file3 u 1:4 ls 3 title label3, \
      file4 u 1:4 ls 4 title label4, \
      file5 u 1:4 ls 5 title label5, \
      file6 u 1:4 ls 6 title label6, \
      file7 u 1:4 ls 7 title label7, \
      file8 u 1:4 ls 8 title label8, \
      abs_m(x) title "|m|"
